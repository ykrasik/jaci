...
public final class ParamDefaultAnnotations {
    ...
    @Getter
    private static final StringParam defaultStringParam = new StringParam() {
        @Override
    ...
    @Getter
    private static final BoolParam defaultBoolParam = new BoolParam() {
        @Override
        public Class<? extends Annotation> annotationType() {
    ...
    @Getter
    private static final IntParam defaultIntParam = new IntParam() {
        @Override
        public Class<? extends Annotation> annotationType() {
    ...
    @Getter
    private static final DoubleParam defaultDoubleParam = new DoubleParam() {
        @Override
        public Class<? extends Annotation> annotationType() {
