...
import com.github.ykrasik.jemi.util.reflection.ReflectionSuppliers;
...
public class StringAnnotationParamFactory extends AnnotationMethodParamFactory<StringParamDef, StringParam> {
    ...
    protected StringParamDef createWithAnnotation(Object instance, ReflectionParameter param, StringParam annotation) throws Exception {
        final StringParamDef.Builder builder = new StringParamDef.Builder(getNonEmptyStringOrDefault(annotation.value(), param.getDefaultName()));
        ...
        if (annotation.optional()) {
            ...
            if (defaultValueSupplierName.isPresent()) {
                builder.setOptional(ReflectionSuppliers.supplier(instance, defaultValueSupplierName.get(), String.class));
            } else {
        ...
        if (valuesSupplierName.isPresent()) {
            builder.setDynamicValues(ReflectionSuppliers.listSupplier(instance, valuesSupplierName.get(), String[].class));
        } else {
