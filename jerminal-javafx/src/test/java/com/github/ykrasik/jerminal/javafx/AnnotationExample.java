...
public class AnnotationExample {
    ...
    @Command
    public void noParamAnnotations(OutputPrinter outputPrinter, int intParam, boolean boolParam, String stringParam, double doubleParam) {
        outputPrinter.println("intParam=%d, boolParam=%s, stringParam=%s, doubleParam=%s", intParam, boolParam, stringParam, doubleParam);
    }
}
