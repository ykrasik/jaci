...
import com.github.ykrasik.jerminal.core.command.PrivilegedCommandOutput;
import com.github.ykrasik.jerminal.core.command.Command;
import com.github.ykrasik.jerminal.core.annotation.param.AnnotationParamFactory;
import com.github.ykrasik.jerminal.core.command.PrivilegedCommandArgs;
...
public class AnnotationCommandFactoryTest {
    ...
    private void execute(Object... args) {
        ...
        final PrivilegedCommandOutput outputPrinter = mock(PrivilegedCommandOutput.class);
    ...
    private static class AnnotationCommandTestClass {
        ...
        @com.github.ykrasik.jerminal.api.Command
        ...
        @com.github.ykrasik.jerminal.api.Command("customName")
        public void commandCustomName() {
            customNameExecuted = true;
        }

        @com.github.ykrasik.jerminal.api.Command(description = "custom description")
