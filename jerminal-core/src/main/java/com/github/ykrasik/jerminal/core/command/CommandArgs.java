 ...
 * {@link com.github.ykrasik.jerminal.cli.parameter.CommandParam#getName()} and will throw a
 ...
 * {@link com.github.ykrasik.jerminal.core.command.Command#getParams()}.
 * <br>
 * Boolean parameters and flags are considered the same for this purpose.
 *
 * @author Yevgeny Krasik
 */
// FIXME: This interface may not be required, as the annotation API is the main API.
...
public interface CommandArgs {
     ...
     */
    String popString() throws IllegalArgumentException;
     ...
     */
    int popInt() throws IllegalArgumentException;
     ...
     */
    double getDouble(String name) throws IllegalArgumentException;
     ...
     */
    double popDouble() throws IllegalArgumentException;
     ...
     */
    boolean getBool(String name) throws IllegalArgumentException;
     ...
     */
    boolean popBool() throws IllegalArgumentException;
}
