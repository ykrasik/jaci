...
package com.github.ykrasik.jerminal.core.directory;
...
public class CommandDirectoryDef {
    /**
    ...
    public static class Builder {
         ...
         */
        public void addCommandDefs(CommandDef... commandDefs) {
            addCommandDefs(Arrays.asList(commandDefs));
        }
         ...
         * @throws IllegalArgumentException If any of the commandDefs' names clash with existing commandDefs under this directory.
         */
        public void addCommandDefs(List<CommandDef> commandDefs) {
