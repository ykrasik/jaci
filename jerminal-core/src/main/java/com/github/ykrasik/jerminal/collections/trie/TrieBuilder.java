...
public class TrieBuilder<T> {
     ...
     */
    public TrieBuilder() {
        this(Collections.<String, T>emptyMap());
    }
    ...
    public TrieBuilder<T> add(String word, T value) {
        ...
        if (map.containsKey(word)) {
            throw new IllegalArgumentException("Trie already contains a mapping for word: " + word);
        }
     ...
     * @return This for chaining.
     * @throws java.lang.IllegalStateException If this Trie already contained any of the map's word-value pairs.
     */
