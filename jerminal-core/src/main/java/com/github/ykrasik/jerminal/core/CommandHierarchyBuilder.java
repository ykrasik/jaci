...
import com.github.ykrasik.jerminal.core.annotation.AnnotationProcessor;
import com.github.ykrasik.jerminal.api.Constants;
import com.github.ykrasik.jerminal.core.command.CommandDef;
import com.github.ykrasik.jerminal.core.directory.CommandDirectoryDef;
import com.github.ykrasik.jerminal.core.directory.CommandDirectoryDef.Builder;
import com.github.ykrasik.jerminal.util.reflection.ReflectionUtils;
import com.github.ykrasik.jerminal.util.string.StringUtils;
...
public class CommandHierarchyBuilder {
    private static final Pattern PATH_PATTERN = Pattern.compile(Constants.PATH_DELIMITER_STRING);
    ...
    private void addCommandDefs(String path, List<CommandDef> commandDefs) {
        ...
        final List<String> splitPath = Arrays.asList(PATH_PATTERN.split(pathWithoutDelimiters));
