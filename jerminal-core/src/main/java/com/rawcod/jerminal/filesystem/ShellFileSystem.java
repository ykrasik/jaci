...
public class ShellFileSystem {
    ...
    public ShellCommand parsePathToCommand(String rawPath) throws ParseException {
        ...
        if (delimiterIndex == -1) {
            ...
            if (globalCommand.isPresent()) {
                ...
                final ShellDirectory currentDirectory = currentDirectoryContainer.getCurrentDirectory();
    ...
    public AutoCompleteReturnValue autoCompletePathToDirectory(String rawPath) throws ParseException {
        ...
        if (delimiterIndex == -1) {
            ...
            final Trie<AutoCompleteType> possibilities = currentDirectoryContainer.getCurrentDirectory().autoCompleteDirectory(rawPath);
    ...
    public AutoCompleteReturnValue autoCompletePath(String rawPath) throws ParseException {
        ...
        if (delimiterIndex == -1) {
            ...
            final Trie<AutoCompleteType> entryPossibilities = currentDirectoryContainer.getCurrentDirectory().autoCompleteEntry(rawPath);
