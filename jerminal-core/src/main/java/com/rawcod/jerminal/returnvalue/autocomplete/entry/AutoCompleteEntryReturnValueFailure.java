 ...
 * Time: 21:48
 */
public class AutoCompleteEntryReturnValueFailure extends ReturnValueImpl.FailureImpl {
    private final AutoCompleteError error;
    private final Optional<String> message;

    private AutoCompleteEntryReturnValueFailure(Builder builder) {
    ...
    public static class Builder {
        ...
        public AutoCompleteEntryReturnValue build() {
            final AutoCompleteEntryReturnValueFailure failure = new AutoCompleteEntryReturnValueFailure(this);
