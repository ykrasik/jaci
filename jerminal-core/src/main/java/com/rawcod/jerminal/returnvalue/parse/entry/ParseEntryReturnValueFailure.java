 ...
 * Time: 19:56
 */
public class ParseEntryReturnValueFailure extends ReturnValueImpl.FailureImpl {
    private final ParseError error;
    private final Optional<String> message;
    private final ShellSuggestion suggestion;

    private ParseEntryReturnValueFailure(Builder builder) {
    ...
    public static class Builder {
        ...
        public ParseEntryReturnValue build() {
            final ParseEntryReturnValueFailure failure = new ParseEntryReturnValueFailure(this);
