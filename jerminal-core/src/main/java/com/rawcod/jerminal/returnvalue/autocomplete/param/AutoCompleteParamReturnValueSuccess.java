 ...
 * Time: 21:46
 */
public class AutoCompleteParamReturnValueSuccess extends ReturnValueImpl.SuccessImpl {
    private final ShellSuggestion suggestion;

    public AutoCompleteParamReturnValueSuccess(ShellSuggestion suggestion) {
