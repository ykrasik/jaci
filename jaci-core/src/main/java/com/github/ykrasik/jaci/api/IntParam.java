...
/**
 * Indicates that the annotated parameter is a int parameter.<br>
 ...
 *                         and returns a {@link Integer} or {@code int} (called the 'supplier').
...
public @interface IntParam {
     ...
     * The supplier must be in the same class, take no args and return a {@link Integer} or {@code int}. May be private.<br>
