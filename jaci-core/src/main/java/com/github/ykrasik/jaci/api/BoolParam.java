...
/**
 * Indicates that the annotated parameter is a boolean parameter.<br>
 ...
 *                         and returns a {@link Boolean} or {@code boolean} (called the 'supplier').
...
public @interface BoolParam {
    ...
    /**
     * Only applicable to boxed {@code Boolean} parameters, will be ignored for primitives.
     *
     ...
     * The supplier must be in the same class, take no args and return a {@link Boolean} or {@code boolean}. May be private.<br>
