...
/**
 * Example usage of LibGdx CLI, using the Java reflection API
 * (incompatible with GWT, but offers all reflection features).
 *
 * Java reflection API is supplied by the dependency 'jaci-libgdx-cli-java' in
 * our Gradle file 'jaci-examples-cli-libgdx-java.gradle'
 *
