...
package com.github.ykrasik.jemi.cli.internal.filesystem.directory;
...
//        manager.addEntry(
//            new CommandDirectoryImpl("nested").addEntries(
...
//                    new CommandDirectoryImpl("singlePossible")
//                ),
//                new CommandDirectoryImpl("directory").addEntries(
//                    new CommandDirectoryImpl("singlePossible").addEntries(
//                        new CommandDirectoryImpl("multiplePossible1").addEntry(
//                            new CommandDirectoryImpl("singlePossible")
//                        ),
//                        new CommandDirectoryImpl("multiplePossible2").addEntry(
//                            new CommandDirectoryImpl("singlePossible")
//                        )
//                    )
//                )
